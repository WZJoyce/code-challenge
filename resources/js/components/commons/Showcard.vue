   ...
   <div class="max-w-xs mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800" >
    ...
    <img class="object-cover w-full h-auto mt-2" v-bind:src="refMessage" > 
        ...
        <div class="flex items-center justify-between px-4 py-2 bg-white"  >
            ...
            <button class="px-2 py-1  text-gray-900 transition-colors duration-200 transform bg-white rounded hover:bg-blue-200 focus:bg-blue-300 focus:outline-none"  @click.stop="editClick" >Edit</button>
      ...
      <form action="#" method="POST" v-show="open">
        <div class="shadow sm:rounded-md sm:overflow-hidden">
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div>  
              <div class="mt-1">
                <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Text"></textarea>
              </div> 
            </div>
          </div>
          <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
            <button type="submit"  @click.stop="submitClick" class="px-2 py-1  text-gray-900 transition-colors duration-200 transform bg-white rounded hover:bg-blue-200 focus:bg-blue-300 focus:outline-none">
              Save
            </button>
          </div>
        </div>
